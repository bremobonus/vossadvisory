#!/bin/bash
# ArtOnly Fix: hemlocke springs republish (correct title, add youtube, outreach, brain.json)
# Generated: 2026-06-23
# Run via GitHub Actions (deploy-artonly.yml)

set -e
cd /home/dh_yadmw3
echo "=== ArtOnly Fix: hemlocke springs republish: $(date) ==="

UA="Mozilla/5.0 (compatible; ArtOnly/1.0)"

# =====================================================================
# Step 5: Republish with correct title + youtube embed
# =====================================================================
echo "--- Republishing hemlocke-springs ---"
python3 << 'PYEOF'
...
# =====================================================================
# Step 6: Social card (regenerate with updated date)
# =====================================================================
