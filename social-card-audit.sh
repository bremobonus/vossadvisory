...
def safe_copy_hero(src_path, hero_path):
    """Copy src to hero_path, removing broken symlinks first."""
    ...
    try:
        ...
        try:
            ...
            raise PermissionError(f'Cannot copy hero image after retry: {e}')
            ...
            if os.path.exists(card_path):
                ...
                if not os.path.exists(hero_path):
                    ...
                    if src_path and os.path.exists(src_path):
                        safe_copy_hero(src_path, hero_path)
