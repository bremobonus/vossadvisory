#!/bin/bash
# ArtOnly — Burna Boy FIX2: add crew/instagram/featured/youtube, send outreach
# sshpass -p 'Neverending48!' ssh -o PreferredAuthentications=password -o StrictHostKeyChecking=no dh_yadmw3@pdx1-shared-a2-06.dreamhost.com 'bash -s' < deploy-artonly-2026-06-26-burna-boy-fix2.sh

echo "=== ArtOnly Fix2: Burna Boy 2026-06-26 ==="
echo "$(date)"
...
# ---- Step 2: Re-publish with full corrected fields ----
echo ""
echo "--- Step 2: Re-publish with crew/instagram/featured/youtube ---"
python3 - << 'PYEOF'
...
# ---- Step 4: Re-enable publishing for outreach ----
echo ""
echo "--- Step 4: Re-enable publishing for outreach ---"
python3 - << 'PYEOF'
import json, os
cfg_path = '/home/dh_yadmw3/artonly.io/data/publish-config.json'
cfg = {}
